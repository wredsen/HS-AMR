 ...
 *
 */
public class ControlRST_Kin implements IControl {
	...
	ControlThread_Kin ctrlThread = null;
	 ...
	 */
	public ControlRST_Kin(IPerception perception, INavigation navigation, NXTMotor leftMotor, NXTMotor rightMotor, IMonitor monitor){
		...
		this.ctrlThread = new ControlThread_Kin(this);
	...
	private void exec_LINECTRL_ALGO(){
		...
		int trajectoryMode = 1; // 0 -> Translation, 1 -> Kreisbahn
		...
		rightMotor.setPower(desiredPowerRight);
