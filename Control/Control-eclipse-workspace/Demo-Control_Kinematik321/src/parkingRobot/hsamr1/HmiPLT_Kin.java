 ...
 *
 */
public class HmiPLT_Kin implements INxtHmi{
...
//	HmiSenderThread hmiSenderThread = new HmiSenderThread(this);
	 ...
	 */
	public HmiPLT_Kin (IPerception perception, INavigation navigation, IControl control, IMonitor monitor) {
		...
		// Changed from original version!
		// separate Thread running the input operations of this module. 
		HmiReaderThread_Kin hmiReaderThread = new HmiReaderThread_Kin(this, monitor);
		// separate Thread running the output operations of this module. 
		HmiSenderThread_Kin hmiSenderThread = new HmiSenderThread_Kin(this, monitor);
