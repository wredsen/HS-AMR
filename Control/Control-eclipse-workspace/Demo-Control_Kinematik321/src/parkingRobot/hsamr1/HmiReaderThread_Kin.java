...
import parkingRobot.hsamr1.HmiPLT_Kin.Command;
 ...
 *
 */
public class HmiReaderThread_Kin extends Thread{
	 ...
	 */
	public HmiReaderThread_Kin(HmiPLT_Kin hmi, IMonitor monitor) {
		this.hmi = hmi;
...
//				monitor.writeHmiComment("Hmi_Reader");
	 ...
	 * This methods is to be called from the {@link HmiReaderThread_Kin HmiThread}. Execution time should be almost equal, because each message consists of 
	 * two integer data. 
	 */
