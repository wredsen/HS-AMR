...
import parkingRobot.hsamr1.Guidance_Kin;
 ...
 *
 */
public class HmiSenderThread_Kin extends Thread{
	 ...
	 */
	public HmiSenderThread_Kin(HmiPLT_Kin hmi, IMonitor monitor) {
		this.hmi = hmi;
...
//				monitor.writeHmiComment("Hmi_Sender");
	...
	private synchronized void processOutputs() {
		...
		try
		{
			...
			hmi.dataOut.writeInt(Guidance_Kin.getCurrentStatus().ordinal());
			hmi.dataOut.flush();
