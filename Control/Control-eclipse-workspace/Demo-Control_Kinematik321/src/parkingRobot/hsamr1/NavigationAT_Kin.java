...
import parkingRobot.hsamr1.NavigationThread_Kin;
 ...
 * @author IfA
 */
public class NavigationAT_Kin implements INavigation{
	 ...
	 */
	NavigationThread_Kin navThread = new NavigationThread_Kin(this);
	 ...
	 */
	public NavigationAT_Kin(IPerception perception, IMonitor monitor){
