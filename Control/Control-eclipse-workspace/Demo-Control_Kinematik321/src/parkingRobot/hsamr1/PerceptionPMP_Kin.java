...
import parkingRobot.hsamr1.PerceptionThread_Kin;
 ...
 * @author PMP
 */
public class PerceptionPMP_Kin implements IPerception {
	...
	PerceptionThread_Kin perThread = new PerceptionThread_Kin(this);
	 ...
	 */
	public PerceptionPMP_Kin(NXTMotor motorLeft, NXTMotor motorRight, IMonitor monitor){
