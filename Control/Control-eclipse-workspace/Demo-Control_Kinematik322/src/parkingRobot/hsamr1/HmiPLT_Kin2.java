 ...
 *
 */
public class HmiPLT_Kin2 implements INxtHmi{
...
//	HmiSenderThread hmiSenderThread = new HmiSenderThread(this);
	 ...
	 */
	public HmiPLT_Kin2 (IPerception perception, INavigation navigation, IControl control, IMonitor monitor) {
		...
		// Changed from original version!
		// separate Thread running the input operations of this module. 
		HmiReaderThread_Kin2 hmiReaderThread = new HmiReaderThread_Kin2(this, monitor);
		// separate Thread running the output operations of this module. 
		HmiSenderThread_Kin2 hmiSenderThread = new HmiSenderThread_Kin2(this, monitor);
