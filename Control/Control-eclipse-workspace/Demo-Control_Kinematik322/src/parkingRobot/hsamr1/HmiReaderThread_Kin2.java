...
import parkingRobot.hsamr1.HmiPLT_Kin2.Command;
 ...
 *
 */
public class HmiReaderThread_Kin2 extends Thread{
	 ...
	 */
	public HmiReaderThread_Kin2(HmiPLT_Kin2 hmi, IMonitor monitor) {
		this.hmi = hmi;
...
//				monitor.writeHmiComment("Hmi_Reader");
	 ...
	 * This methods is to be called from the {@link HmiReaderThread_Kin2 HmiThread}. Execution time should be almost equal, because each message consists of 
	 * two integer data. 
	 */
