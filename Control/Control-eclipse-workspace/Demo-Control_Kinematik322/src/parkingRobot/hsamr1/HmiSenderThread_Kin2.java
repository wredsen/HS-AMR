 ...
 *
 */
public class HmiSenderThread_Kin2 extends Thread{
	 ...
	 */
	public HmiSenderThread_Kin2(HmiPLT_Kin2 hmi, IMonitor monitor) {
		this.hmi = hmi;
...
//				monitor.writeHmiComment("Hmi_Sender");
	...
	private synchronized void processOutputs() {
		...
		try
		{
			...
			hmi.dataOut.writeInt(Guidance_Kin2.getCurrentStatus().ordinal());
			hmi.dataOut.flush();
