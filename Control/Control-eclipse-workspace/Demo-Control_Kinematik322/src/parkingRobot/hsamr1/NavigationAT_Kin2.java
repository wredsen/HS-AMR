...
import parkingRobot.hsamr1.NavigationThread_Kin2;
 ...
 * @author IfA
 */
public class NavigationAT_Kin2 implements INavigation{
	 ...
	 */
	NavigationThread_Kin2 navThread = new NavigationThread_Kin2(this);
	 ...
	 */
	public NavigationAT_Kin2(IPerception perception, IMonitor monitor){
