 ...
 *
 */
public class ControlRST_PID implements IControl {
	...
	ControlThread_PID ctrlThread = null;
	 ...
	 */
	public ControlRST_PID(IPerception perception, INavigation navigation, NXTMotor leftMotor, NXTMotor rightMotor, IMonitor monitor){
		...
		this.ctrlThread = new ControlThread_PID(this);
