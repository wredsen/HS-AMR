 ...
 *
 */
public class HmiPLT_PID implements INxtHmi{
...
//	HmiSenderThread hmiSenderThread = new HmiSenderThread(this);
	 ...
	 */
	public HmiPLT_PID (IPerception perception, INavigation navigation, IControl control, IMonitor monitor) {
		...
		// Changed from original version!
		// separate Thread running the input operations of this module. 
		HmiReaderThread_PID hmiReaderThread = new HmiReaderThread_PID(this, monitor);
		// separate Thread running the output operations of this module. 
		HmiSenderThread_PID hmiSenderThread = new HmiSenderThread_PID(this, monitor);
