...
import parkingRobot.hsamr1.HmiPLT_PID.Command;
 ...
 *
 */
public class HmiReaderThread_PID extends Thread{
	 ...
	 */
	public HmiReaderThread_PID(HmiPLT_PID hmi, IMonitor monitor) {
		this.hmi = hmi;
...
//				monitor.writeHmiComment("Hmi_Reader");
	 ...
	 * This methods is to be called from the {@link HmiReaderThread_PID HmiThread}. Execution time should be almost equal, because each message consists of 
	 * two integer data. 
	 */
