 ...
 *
 */
public class HmiSenderThread_PID extends Thread{
	 ...
	 */
	public HmiSenderThread_PID(HmiPLT_PID hmi, IMonitor monitor) {
		this.hmi = hmi;
...
//				monitor.writeHmiComment("Hmi_Sender");
	...
	private synchronized void processOutputs() {
		...
		try
		{
			...
			hmi.dataOut.writeInt(Guidance_PID.getCurrentStatus().ordinal());
			hmi.dataOut.flush();
