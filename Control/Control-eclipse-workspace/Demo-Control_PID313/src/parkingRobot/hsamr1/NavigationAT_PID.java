...
import parkingRobot.hsamr1.NavigationThread_PID;
 ...
 * @author IfA
 */
public class NavigationAT_PID implements INavigation{
	 ...
	 */
	NavigationThread_PID navThread = new NavigationThread_PID(this);
	 ...
	 */
	public NavigationAT_PID(IPerception perception, IMonitor monitor){
