...
import parkingRobot.hsamr1.PerceptionThread_PID;
 ...
 * @author PMP
 */
public class PerceptionPMP_PID implements IPerception {
	...
	PerceptionThread_PID perThread = new PerceptionThread_PID(this);
	 ...
	 */
	public PerceptionPMP_PID(NXTMotor motorLeft, NXTMotor motorRight, IMonitor monitor){
