 ...
 *
 */
public class ControlRST_Ver11 implements IControl {
	...
	ControlThread_Ver11 ctrlThread = null;
	 ...
	 */
	public ControlRST_Ver11(IPerception perception, INavigation navigation, NXTMotor leftMotor, NXTMotor rightMotor, IMonitor monitor){
    ...
    private void exec_FAST_ALGO() {
    	...
    	leftMotor.forward();
		rightMotor.forward();
		PID_Ver11 lineFollowPIDFast = new PID_Ver11(0, SAMPLETIME, 0.2, 0, 0.05, 999999, false);
