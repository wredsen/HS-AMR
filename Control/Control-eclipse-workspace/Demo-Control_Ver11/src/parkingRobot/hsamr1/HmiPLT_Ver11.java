 ...
 *
 */
public class HmiPLT_Ver11 implements INxtHmi{
...
//	HmiSenderThread hmiSenderThread = new HmiSenderThread(this);
	 ...
	 */
	public HmiPLT_Ver11 (IPerception perception, INavigation navigation, IControl control, IMonitor monitor) {
		...
		// Changed from original version!
		// separate Thread running the input operations of this module. 
		HmiReaderThread_Ver11 hmiReaderThread = new HmiReaderThread_Ver11(this, monitor);
		// separate Thread running the output operations of this module. 
		HmiSenderThread_Ver11 hmiSenderThread = new HmiSenderThread_Ver11(this, monitor);
