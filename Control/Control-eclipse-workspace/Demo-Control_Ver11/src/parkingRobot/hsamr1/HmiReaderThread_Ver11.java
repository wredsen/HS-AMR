...
import parkingRobot.hsamr1.HmiPLT_Ver11.Command;
 ...
 *
 */
public class HmiReaderThread_Ver11 extends Thread{
	 ...
	 */
	public HmiReaderThread_Ver11(HmiPLT_Ver11 hmi, IMonitor monitor) {
		this.hmi = hmi;
...
//				monitor.writeHmiComment("Hmi_Reader");
	 ...
	 * This methods is to be called from the {@link HmiReaderThread_Ver11 HmiThread}. Execution time should be almost equal, because each message consists of 
	 * two integer data. 
	 */
