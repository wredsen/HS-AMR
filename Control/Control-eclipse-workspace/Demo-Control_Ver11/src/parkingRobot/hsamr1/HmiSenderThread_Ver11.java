...
import parkingRobot.hsamr1.Guidance_Ver11;
 ...
 *
 */
public class HmiSenderThread_Ver11 extends Thread{
	 ...
	 */
	public HmiSenderThread_Ver11(HmiPLT_Ver11 hmi, IMonitor monitor) {
		this.hmi = hmi;
...
//				monitor.writeHmiComment("Hmi_Sender");
	...
	private synchronized void processOutputs() {
		...
		try
		{
			...
			hmi.dataOut.writeInt(Guidance_Ver11.getCurrentStatus().ordinal());
			hmi.dataOut.flush();
