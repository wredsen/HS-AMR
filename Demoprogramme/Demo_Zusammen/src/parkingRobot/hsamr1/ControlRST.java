...
public class ControlRST implements IControl {
	...
	INavigation3 navigation3 = null;
	INavigation2 navigation2 = null;
	 ...
	 */
	public ControlRST(IPerception perception, INavigation3 navigation, NXTMotor leftMotor, NXTMotor rightMotor, IMonitor monitor){
		this.perception = perception;
        this.navigation3 = navigation;
	...
	public ControlRST(IPerception perception, INavigation2 navigation, NXTMotor leftMotor, NXTMotor rightMotor, IMonitor monitor){
		this.perception = perception;
        this.navigation2 = navigation;
        this.monitor = monitor;
		this.leftMotor = leftMotor;
		this.rightMotor = rightMotor;
