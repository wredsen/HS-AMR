...
public class NavigationThread extends Thread {
	 ...
	 */
	INavigation3 navigation3;
	INavigation2 navigation2;
	 ...
	 */
	NavigationThread(INavigation3 navigation3){
    	this.navigation3 = navigation3;
    }
	
	NavigationThread(INavigation2 navigation2){
