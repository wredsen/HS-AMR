...
import parkingRobot.hsamr1.HmiPLT_Ver11;
import parkingRobot.hsamr1.NavigationAT_Ver11;
import parkingRobot.hsamr1.PerceptionPMP_Ver11;
...
public class CTR_D1 {
	...
	public static void main(String[] args) throws Exception {		
		...
		IMonitor monitor = new Monitor_Ver11();
		
		IPerception perception = new PerceptionPMP_Ver11(leftMotor, rightMotor, monitor);
		//perception.calibrateLineSensors();
		
		INavigation navigation = new NavigationAT_Ver11(perception, monitor);
		IControl    control    = new ControlRST_Ver11(perception, navigation, leftMotor, rightMotor, monitor);
