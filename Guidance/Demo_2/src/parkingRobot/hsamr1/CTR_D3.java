...
import parkingRobot.hsamr1.CTR_D3.CurrentStatusDrive;
	...
	public static void main(String[] args) throws Exception {		
		...
		while(true) {
			...
			case LINE_FOLLOW:
				...
				if ((Math.abs(navigation.getPose().getX())<0.05) && (Math.abs(navigation.getPose().getY())<0.05) && (Math.abs(navigation.getPose().getHeading())<Math.toRadians(20))) {
