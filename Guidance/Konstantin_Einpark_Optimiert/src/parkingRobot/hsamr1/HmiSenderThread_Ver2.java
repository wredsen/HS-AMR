...
import parkingRobot.hsamr1.HmiPLT_Ver2.Command;
 ...
 *
 */
public class HmiSenderThread_Ver2 extends Thread{
	 ...
	 */
	public HmiSenderThread_Ver2(HmiPLT_Ver2 hmi, IMonitor monitor) {
		this.hmi = hmi;
...
//				monitor.writeHmiComment("Hmi_Sender");
	...
	private synchronized void processOutputs() {
		...
		try
		{
			...
			hmi.dataOut.writeInt(CTR_D3.getCurrentStatus().ordinal());
			hmi.dataOut.flush();
