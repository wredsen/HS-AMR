package amr.plt.rcParkingRobot;

import parkingRobot.INxtHmi.Mode;
import parkingRobot.IGuidance.CurrentStatus;
...
public interface IAndroidHmi {
	...
	public List<ParkingSlot> getArray();
	/**
	...
	public class ParkingSlot {		
		...
		/**
		 * characterization of the parking slot measurement: SUITABLE_FOR_PARKING - indicates, that the parking slot is suitable for parking,
		 * NOT_SUITABLE_FOR_PARKING - indicates, that the parking slot is not suitable for parking
		 */
