...
public class BluetoothActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		MaterialButton cancel_btn = (MaterialButton) findViewById(R.id.cancel_button);
		...
		MaterialButton disconnect_btn = (MaterialButton) findViewById(R.id.disconnect_button);
		...
		connected = serverIntent.getBooleanExtra("already_connected", false);
		if (!connected){
