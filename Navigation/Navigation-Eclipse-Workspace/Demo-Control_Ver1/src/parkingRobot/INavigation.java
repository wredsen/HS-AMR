...
public interface INavigation {
	...
	/**
	 * Gives the current corner type back.
	 * @return true if the current corner is a left corner, false if it is a right corner
	 */
	public boolean getCornerType();
	
	/**
	 * Gives the current corner number back.
	 * @return corner number between 0 and 7
	 */
