...
public class NavigationAT_Ver1 implements INavigation{
	...
	public synchronized boolean getCornerArea() {
		...
		if (mapModus == 1) {
			if ((this.pose.getX()<=0.10)&&(this.pose.getY()<=0.10) && areaNumber != 1) {								
				area = true;
				areaNumber = 0;
			}
			...
			if ((this.pose.getX()>=1.60)&&(this.pose.getY()>=0.20) && areaNumber != 3) {
				area = true;
				areaNumber = 2;
			}
		
			if ((this.pose.getX()>=1.40)&&(this.pose.getX()<=1.60)&&(this.pose.getY()>=0.50) && areaNumber != 4) {
				area = true;
				areaNumber = 3;
			}
		
			if ((this.pose.getX()>=1.40)&&(this.pose.getX()<=1.60)&&(this.pose.getY()>=0.20)&&(this.pose.getY()<=0.50) && areaNumber != 5) {
				area = true;
				areaNumber = 4;
			}
		
			if ((this.pose.getX()>=0.20)&&(this.pose.getX()<=0.40)&&(this.pose.getY()>=0.20)&&(this.pose.getY()<=0.50) && areaNumber != 6) {
				area = true;
				areaNumber = 5;
			}
		
			if ((this.pose.getX()>=0.20)&&(this.pose.getX()<=0.40)&&(this.pose.getY()>=0.50) && areaNumber != 7) {
				area = true;
				areaNumber = 6;
			}
		
			if ((this.pose.getX()<=0.20)&&(this.pose.getY()>=0.50) && areaNumber != 0) {
				area = true;
				areaNumber = 7;
			}
		}
