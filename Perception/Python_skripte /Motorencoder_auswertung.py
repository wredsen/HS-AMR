...
for i in range(1,10): #itterate thru all files
   j=0
   k=0
   l=0
   with open("/home/sebastian/Dokumente/Mitschriften/WISE_2020/Hauptseminar/HS-AMR/Control/NXTData"+str(i*10)+"cm.txt","r") as file: #open i'ten file 
...
p = np.polyfit(gauss_array[:, 0],gauss_array[:, 1],6)                              #make a polynomial fit of 6 degree
