...
print('black bright mean  '+str(mean_value_right[0,0]))
print('black bright sigma '+str(mean_value_right[0,1]))
print('black dark mean    '+str(mean_value_right[1,0]))
print('black bright sigma '+str(mean_value_right[1,1]))
print('gray bright mean   '+str(mean_value_right[2,0]))
print('black bright sigma '+str(mean_value_right[2,1]))
print('gray dark mean     '+str(mean_value_right[3,0]))
print('black bright sigma '+str(mean_value_right[3,1]))
print('white bright mean  '+str(mean_value_right[4,0]))
print('black bright sigma '+str(mean_value_right[4,1]))
print('white dark mean    '+str(mean_value_right[5,0]))
print('black bright sigma '+str(mean_value_right[5,1]))
