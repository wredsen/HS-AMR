 ...
 *
 */
public class HmiSenderThread_Ver1 extends Thread{
	 ...
	 */
	public HmiSenderThread_Ver1(HmiPLT_Ver1 hmi, IMonitor monitor) {
		this.hmi = hmi;
...
//				monitor.writeHmiComment("Hmi_Sender");
	...
	private synchronized void processOutputs() {
		...
		try
		{
			...
			hmi.dataOut.writeInt(Guidance_Vs1.getCurrentStatus().ordinal());
			hmi.dataOut.flush();
