...
import parkingRobot.hsamr1.Guidance_Vs1;
...
public class NavigationAT_Ver1 implements INavigation{
	...
	public synchronized void updateNavigation(){	
		...
		LCD.drawString("sf = "+ perception.getFrontSensorDistance(), 0, 5);
	...
	public boolean detectCorner() {
		...
		if (perception.getFrontSensorDistance() < 15 && perception.getFrontSensorDistance() > 13) {
			//evaluateCornerDetection();
			LCD.drawString("ecke erkannt", 0, 6);
			return true;
		}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	Lokalisierungsauswertung
			...
			if(angleResult>=2*Math.PI) {
				...
				if(!(Guidance_Vs1.getCurrentStatus() == Guidance_Vs1.CurrentStatus.INACTIVE || 
				   Guidance_Vs1.getCurrentStatus() == Guidance_Vs1.CurrentStatus.EXIT) && (mapModus==1)){
				//	Linie 1
